...
-(void)configUIWithData{
    ...
    CGFloat spaceWidth=(kFanScreenWidth-kFanEachNum*kFanShareWidth)/(kFanEachNum+1);
    ...
    self.fan_cententView=[[UIView alloc]initWithFrame:CGRectMake(0, kFanScreenHeight-self.contentHeight, kFanScreenWidth, self.contentHeight)];
    ...
    [cancelBtn setFrame:CGRectMake(0, self.contentHeight-45, kFanScreenWidth, 45)];
...
-(void)removeSelfView{
    ...
    [self.fan_cententView setFrame:CGRectMake(0, kFanScreenHeight, kFanScreenWidth, self.contentHeight)];
