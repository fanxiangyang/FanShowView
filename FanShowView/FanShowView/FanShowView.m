...
-(instancetype)initWithStyle:(FanShowViewStyle)style{
    self=[super init];
    if (self) {
        self.frame=CGRectMake(0, 0, kFanScreenWidth, kFanScreenHeight);
...
-(void)configUIWithData{
    self.blackAlphaView=[[UIView alloc]initWithFrame:CGRectMake(0, 0, kFanScreenWidth, kFanScreenHeight)];
...
//        _blackAlphaView=[[UIView alloc]initWithFrame:CGRectMake(0, 0, kFanScreenWidth, kFanScreenHeight)];
//    }
